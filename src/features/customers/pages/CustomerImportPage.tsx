  ...
  const downloadErrors = () => {
    ...
    exportExcel(
      ...
      [
        ...
        {
          label: "Empresa",
          value: (item) => byNumber.get(item.rowNumber)?.data.companyName ?? "",
        },
  ...
  return (
    <main className="customers-content customer-import-page">
      <PageHeader
        ...
        action={
          <Link className="back-button" to="/customers">
        ...
        <>
            ...
            <section className="import-wizard-card import-review-card">
              ...
              <footer className="import-wizard-actions">
                ...
                >
                  {commit.isPending
                    ? "Importando…"
                    : `Importar ${selectedRows.length} clientes`}
                </button>
              </footer>
            </section>
          )}
          {step === 3 && result && (
            <section className="import-wizard-card import-result-card">
              ...
              <footer className="import-wizard-actions">
                <Link to="/customers">Ir al listado</Link>
