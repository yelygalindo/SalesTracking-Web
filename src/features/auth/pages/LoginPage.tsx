...
export function LoginPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      setError(
        reason instanceof AppError || reason instanceof Error
          ? reason.message
    ...
    <main className="login-page">
      <section className="login-hero">
        ...
        <div className="hero-copy">
          <span className="pill">Gestión comercial en movimiento</span>
          <h1>
            Tu operación,
            <br />
            siempre en ruta.
          ...
          <div className="security-note">
            ...
            <div>
              ...
              <small>
                Tu información protegida y disponible para tu equipo.
              </small>
            </div>
          </div>
        </div>
        <small className="copyright">
          © 2026 UrbanTrack. Todos los derechos reservados.
        </small>
      </section>
      <section className="login-form-panel">
        <div className="login-form-wrap">
          ...
          <p className="overline">Bienvenido</p>
          <h2>Inicia sesión</h2>
          ...
          <p className="help">
            ¿Necesitas ayuda? <strong>Contacta a soporte</strong>
          </p>
        </div>
      </section>
    </main>
